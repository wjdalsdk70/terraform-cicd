resource "aws_rds_cluster" "rds-cluster" {
  cluster_identifier              = lower("aws-rds-cluster-dev-jm4520-aurora-jm4520-db")
...
resource "aws_rds_cluster_instance" "rds-instance" {
  ...
  identifier                  = lower("aws-rds-instance-dev-jm4520-aurora-jm4520db-${count.index}")
...
resource "aws_rds_cluster_parameter_group" "rds-cluster-parameter-group" {
  name=lower("aws-rds-cluster-parameter-group-dev-jm4520-aurora-jm4520-db")
...
resource "aws_db_parameter_group" "rds-instance-parameter-group" {
  name        = lower("aws-rds-instance-parameter-group-dev-jm4520-aurora-jm4520-db")
